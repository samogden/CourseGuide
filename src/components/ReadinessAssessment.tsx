...
const genericAssessmentScript = assessmentScript.replace('Reviewing missed skills could make MATH 130 more comfortable.', 'Reviewing missed skills could make the next math course more comfortable.')
